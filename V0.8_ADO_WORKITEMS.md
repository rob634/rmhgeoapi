...
**Created**: 30 JAN 2026
**Revised**: 31 JAN 2026 (Final: reordered features, renumbered stories)
...
#### US 1.1: CoreMachine Orchestration `[CLOSED]`
...
#### US 1.3: Queue Architecture `[CLOSED]`
...
#### US 1.4: Metadata Architecture `[CLOSED]`
**As a** data steward
...
#### US 1.6: FATHOM Flood Data Pipeline `[ACTIVE]`
...
#### US 1.7: VirtualiZarr Pipeline `[NEW]`
**As a** climate data manager
...
#### US 5.5: OGC Features API `[ACTIVE]`
**As a** data scientist
...
## FEATURE 6: Admin & Developer Portal `[CLOSED]`
...
#### US 6.2: Developer Integration Portal `[CLOSED]`
...
|---------|--------|--------------|----------|
| F1: ETL Pipeline Orchestration | Active | 7 | 5/7 |
...
| F6: Admin & Developer Portal | Closed | 2 | 2/2 |
