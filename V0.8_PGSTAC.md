...
### 1. Search Rendering (Composite View)
Returns a **single composite tile** blending all matching items:
...
| **Latest composite** | Registered search + search tiles | Single tile showing latest/best pixels |
