...
|----------|---------|---------|
| **OGC API - Features** | Query vector data as GeoJSON (full resolution or server-simplified) | Desktop and Web Apps |
| **OGC API - Tiles** | Serve map tiles (raster & vector) | Web Apps |
| **STAC** | Catalog & discover datasets | Desktop and Web Apps |
| **Cloud Optimized GeoTIFF** | Stream raster data without download | Desktop and Web Apps |
