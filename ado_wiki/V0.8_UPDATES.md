...
- `templates/pages/raster/viewer.html` - QA Review section (lines 178-195)
- `templates/pages/vector/viewer.html` - QA Review section (lines 150-167)
- `web_interfaces/__init__.py` - Embed mode handler (lines 178-210)
- `web_interfaces/base.py` - `embed_mode` flag skips navbar

**Usage for B2B**:
```html
<!-- Embed raster viewer in B2B app -->
<iframe src="https://gateway-url/interface/raster/viewer/{collection_id}?embed=true"
        width="100%" height="800px"></iframe>

<!-- Embed vector viewer in B2B app -->
<iframe src="https://gateway-url/interface/vector/viewer/{collection_id}?embed=true"
        width="100%" height="800px"></iframe>
```
