...
Azure Monitor Autoscale
         │
         ▼ scale actions
App Service Plan (ASP-<platform>)
         │
         ▼ hosts
Function App (<platform-function-app>)
```
...
| **Target Resource** | `ASP-<platform>` (App Service Plan) |
| **Min Instances** | 1 |
| **Max Instances** | 4 |
...
az monitor autoscale show --name <autoscale-setting> --resource-group <resource-group>

# Check current instance count
az appservice plan show --name ASP-<platform> --resource-group <resource-group> \
  --query "{workers:properties.numberOfWorkers, maxWorkers:sku.capacity}"

# Emergency: Disable autoscale
az monitor autoscale update --name <autoscale-setting> --resource-group <resource-group> --enabled false

# Manually scale to 1 instance
az appservice plan update --name ASP-<platform> --resource-group <resource-group> --number-of-workers 1
```
...
az monitor autoscale create \
  ...
  --resource /subscriptions/{sub-id}/resourceGroups/<resource-group>/providers/Microsoft.Web/serverfarms/ASP-<platform> \
...
az monitor autoscale rule create \
  ...
  --resource /subscriptions/{sub-id}/resourceGroups/<resource-group>/providers/Microsoft.ServiceBus/namespaces/<platform>
