...
This document provides **complete setup instructions** for Azure Service Bus in the <platform-function-app> geospatial data processing application. Use this guide when you have:
