...
# Note: JobRegistration and JobRegistry have been removed in Phase 4 of the registration refactoring.
# They are replaced by the non-singleton JobCatalog and TaskCatalog in registration.py.
