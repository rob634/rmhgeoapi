...
# ============================================================================
# PURPOSE: Formal schemas for dynamic orchestration pattern in Job→Stage→Task workflow (both pipelines)
...
# INDEX:
#   - Line 46: Core enums (OrchestrationAction, ItemType)
#   - Line 72: OrchestrationItem base model
#   - Line 152: OrchestrationInstruction model
#   - Line 265: DynamicOrchestrationResult model
#   - Line 341: Helper models for specific patterns (FileOrchestrationItem, etc.)
# ============================================================================
