...
# ============================================================================
# PURPOSE: Universal queue message schemas for both Azure Storage Queues and Service Bus
...
# SCOPE: Queue message validation and serialization for both queue systems
# VALIDATION: Pydantic v2 field validators and constraints
# PATTERNS: Data model pattern, Message pattern, Universal message format
# ENTRY_POINTS: from schema_queue import JobQueueMessage, TaskQueueMessage
# INDEX: JobQueueMessage:64, TaskQueueMessage:97
# ============================================================================

"""
Universal Queue Message Schemas - Dual Pipeline Integration

This module defines the message formats for job and task queues,
used by BOTH Azure Storage Queues and Azure Service Bus pipelines.
These schemas provide a consistent message contract across both systems.
...
4. Consistent message format across both Storage Queue and Service Bus pipelines
"""
