...
# PURPOSE: Pydantic models for geo.table_catalog, geo.feature_collection_styles, geo.b2c_routes, geo.b2b_routes
# LAST_REVIEWED: 02 MAR 2026
# EXPORTS: GeoTableCatalog, FeatureCollectionStyles, B2CRoute, B2BRoute
...
class _RouteBase(BaseModel):
    ...
    Design:
        ...
        - data_type determines which resolution fields apply:
            ...
            zarr    -> stac_item_id + stac_collection_id + blob_path
