...
# REVIEW_STATUS: V0.9 cleanup — removed dead V0.8 upsert_geospatial_asset stored proc
# ============================================================================
"""
Pydantic to PostgreSQL Schema Generator.
...
from ..models.zarr_metadata import ZarrMetadataRecord  # Zarr metadata (22 MAR 2026 - v0.10.6)
...
""").format(
    ...
    def generate_composed_statements(self) -> List[sql.Composed]:
        ...
        composed.append(self.generate_table_composed(ZarrMetadataRecord, "zarr_metadata"))  # Zarr metadata (22 MAR 2026 - v0.10.6)
        ...
        composed.extend(self.generate_indexes_composed("zarr_metadata", ZarrMetadataRecord))  # Zarr metadata (22 MAR 2026 - v0.10.6)
