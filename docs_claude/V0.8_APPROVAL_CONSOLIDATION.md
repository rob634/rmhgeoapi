...
**Created**: 08 FEB 2026
**Status**: COMPLETE - Phases 1-4 Complete (08 FEB 2026)
...
- [ ] Move legacy files to docs/archive/v0.7_approval/ (optional - files no longer imported)

### Phase 5: Schema
- [ ] Run schema ensure to add new columns
- [ ] Optionally drop dataset_approvals table
- [ ] Verify indexes
