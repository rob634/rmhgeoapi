...
# ============================================================================
# PURPOSE: Formal schemas for dynamic orchestration pattern in Job→Stage→Task workflow
# EXPORTS: OrchestrationInstruction, DynamicOrchestrationResult, OrchestrationItem, OrchestrationMetadata
...
# SCOPE: Used by controllers implementing dynamic task generation
# VALIDATION: Pydantic automatic validation with custom validators
# PATTERNS: Data Transfer Objects for orchestration communication
# ENTRY_POINTS: Import and use in controller aggregate_stage_results methods
# INDEX:
#   - Line 30: Core enums
#   - Line 50: OrchestrationItem base model
#   - Line 90: OrchestrationInstruction model
#   - Line 150: DynamicOrchestrationResult model
#   - Line 200: Helper models for specific patterns
# ============================================================================
