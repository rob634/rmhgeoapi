# ============================================================================
# CLAUDE CONTEXT - ASSET SERVICE V2 (ASSET/RELEASE LIFECYCLE)
# ============================================================================
# EPOCH: 5 - ACTIVE
...
# EXPORTS: AssetServiceV2, ReleaseExistsError, ReleaseNotFoundError, ReleaseStateError
# DEPENDENCIES: infrastructure.asset_repository_v2, infrastructure.release_repository
# ============================================================================
"""
Asset Service V2 -- Asset/Release Lifecycle Orchestration.
...
Key Flows:
    ...
    - Approval: assign_version() (called by AssetApprovalServiceV2)
    - Status: get_release(), get_latest_release(), get_version_history()

Exports:
    AssetServiceV2: Lifecycle orchestration for Asset + Release
...
from core.models.asset_v2 import (
    Asset,
    AssetRelease,
    ApprovalState,
    ClearanceState,
...
logger = LoggerFactory.create_logger(ComponentType.SERVICE, "AssetServiceV2")
...
class AssetServiceV2:
    ...
    def __init__(self):
        ...
        from infrastructure.asset_repository_v2 import AssetRepositoryV2
        from infrastructure.release_repository import ReleaseRepository
        self.asset_repo = AssetRepositoryV2()
    ...
    def find_or_create_asset(
        ...
        Delegates to AssetRepositoryV2.find_or_create() which uses advisory
    ...
    # =========================================================================
    # VERSION ASSIGNMENT (called by AssetApprovalServiceV2)
    # =========================================================================
    ...
    def assign_version(
        ...
        Called by AssetApprovalServiceV2 when approving a release. This:
