"""
Poison Queue Monitor HTTP Trigger.

HTTP endpoint for poison queue monitoring and cleanup (deprecated - Storage Queues).

Exports:
    PoisonQueueMonitorTrigger: HTTP trigger class for poison queue monitoring
    poison_queue_monitor_trigger: Singleton instance of PoisonQueueMonitorTrigger
"""
