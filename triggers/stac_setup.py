...
HTTP endpoints for PgSTAC installation and status checking.

Exports:
    StacSetupTrigger: HTTP trigger class for STAC infrastructure management
    stac_setup_trigger: Singleton instance of StacSetupTrigger
"""
