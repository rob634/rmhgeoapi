    ...
    def _fragment_submit_options(self, request: func.HttpRequest) -> str:
        ...
        if data_type == "raster":
            return (
                ...
                '</div>'
                '<div class="form-group" style="flex:1; min-width:180px;">'
                '<label class="filter-label">Raster Type:'
                '<input type="text" name="po_raster_type" class="filter-input"'
                ' placeholder="auto, rgb, dem, etc."></label>'
                '</div>'
                '<div class="form-group" style="flex:1; min-width:180px;">'
                '<label class="filter-label">Output Tier:'
                '<input type="text" name="po_output_tier" class="filter-input"'
                ' placeholder="analysis, visualization"></label>'
                '</div>'
                '</div>'
            )
