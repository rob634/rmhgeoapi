...
class SubmitRasterCollectionInterface(BaseInterface):
    ...
    def _render_submit_fragment(self, request: func.HttpRequest) -> str:
        ...
        try:
            ...
            # Build Platform API payload for collection
            platform_payload = {
            ...
            if collection_description:
                platform_payload['collection_description'] = collection_description
            ...
            from triggers.trigger_platform import _create_and_submit_job
            ...
            # Build job parameters for process_raster_collection_v2
            job_params = {
                'container_name': container_name,
                'blob_list': blob_list,
                'collection_id': collection_id,
            ...
            if collection_description:
                job_params['collection_description'] = collection_description
            if raster_type and raster_type != 'auto':
                job_params['raster_type'] = raster_type
            if output_tier:
                job_params['output_tier'] = output_tier
            if input_crs:
                job_params['crs'] = input_crs

            # Create and submit job
            job_id = _create_and_submit_job("process_raster_collection_v2", job_params, request_id)
    ...
    def _render_submit_success_platform(self, result: dict, payload: dict) -> str:
        ...
        file_count = result.get('file_count', len(payload.get('blob_list', [])))
        ...
        <div class="submit-result success">
            ...
            <div class="result-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{payload.get('collection_id', 'N/A')}</span>
                </div>
                <div class="detail-row">
